"""Process Humboldt journal: Reise von Cumaná bis Villa de Cura (H1242132).

American travel journals III (Venezuela). Run from the project root with the venv:
    python run_america.py
"""
...
JOURNAL_DIR = Path(r"C:/Users/totom/Projects/Humboldt/H1242132_humboldt")
IMAGE_FOLDER = JOURNAL_DIR / "images"            # 63 images live in images/
GT_TEI = JOURNAL_DIR / "tei" / "H1242132.xml"
OUTPUT_FOLDER = PROJECT_DIR / "output_america_full"
OUTPUT_FOLDER.mkdir(exist_ok=True)

# Settings
MAX_PAGES = None          # None = all 63 folios; set e.g. 3 for a quick test
...
results = process_book(
    ...
    book_title="Alexander von Humboldt - Reise von Cumana bis Villa de Cura (Amerikanische Reisetagebuecher III)",
)
...
html_path = generate_html_edition(
    results=results,
    output_path=OUTPUT_FOLDER / "humboldt_cumana_villa_de_cura.html",
    title="Alexander v. Humboldt - The Inaccurate Edition",
    subtitle="Reise von Cumaná bis Villa de Cura - Amerikanische Reisetagebücher III",
